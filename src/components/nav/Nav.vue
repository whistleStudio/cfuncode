...
<div class="nav">
  ...
  <div class="mod flex-v-center">
    <a-segmented class="mod-seg flex-v-center" v-model:value="selectMod" :options="modOpt" @change="selectChange">
      <template #label="{ payload }">
        <div class="mod-item flex-v-center" :class="{'mod-item-select': selectMod==payload.val}">
...
function selectChange () {
  emits("showModChange", selectMod.value)
}
/* 新建/打开/上传 */
